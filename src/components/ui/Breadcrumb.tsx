// This is copied from a PR before its merge:
// https://github.com/shadcn-ui/ui/pull/133
// This code should be updated when the author of shadcn-ui adds the component
// officially.
